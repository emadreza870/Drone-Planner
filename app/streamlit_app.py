...
def main():
    ...
    with st.sidebar:
        ...
        # دکمه تولید برنامه
        generate_btn = st.button("تولید برنامه پروازی")
    ...
    if generate_btn:
        ...
        # بررسی باتری برای هر پهپاد در هر شیفت - نیاز به تطبیق
        # (در این نسخه ساده، از مقادیر داخل شیفت استفاده می‌کنیم)
